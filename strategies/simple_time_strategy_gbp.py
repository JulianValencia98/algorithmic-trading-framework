...
class SimpleTimeStrategyGBP(StrategyBase):
    """
    Strategy for GBPUSD that opens a buy position, keeps it open for 20 minutes, 
    ...
    def __init__(self):
        super().__init__()
        self.magic_number = 2  # Unique identifier for this strategy
    ...
    def get_parameters(self) -> dict:
        return {
            'strategy_name': 'SimpleTimeStrategyGBP',
            'magic_number': self.magic_number,
            'description': 'Opens buy position on GBPUSD, waits 20 min, closes and reopens',
            
            # Position Management
            'close_before_open': True,   # Close existing positions before opening new
